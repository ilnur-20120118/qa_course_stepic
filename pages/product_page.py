...
class ProductPage(BasePage):
    def add_to_shoping_cart(self):
        assert self.is_element_present(*ProductPageLocators.ADD_CARD), \
        "cart botton not found"
    ...
    def should_not_disappear_msg(self):
        x = self.is_disappeared(*ProductPageLocators.MSG_ADD_PRODUCT)
    ...
    def examination_correct_msg(self):
        """ Сообщение о том, что товар добавлен в корзину. Название товара в
        сообщении должно совпадать с тем товаром,
        ...
        assert name_product == msg_about_product_add_in_basket, \
        "название продукта не совпадает или что-то еще"

    def examination_correct_price_in_basket(self):
        """ Сообщение со стоимостью корзины. Стоимость корзины совпадает
        с ценой товара.
        """
